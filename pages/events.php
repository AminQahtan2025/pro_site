...
<head>
    ...
    <title>Dr. Abdullah Al-Swidi - Events</title>
    <!-- Bootstrap and CSS -->
...
<body>
    <div class="container">
        <!-- Banner Image -->
        <div class="banner">
            <img src="../images/banner.jpeg" alt="Events Banner" class="img-fluid w-100 shadow-sm">
        </div>
        ...
        <div class="container border">
            <h1 class="text-center m-4">Events</h1>
            <div class="row g-3">
                <?php
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '
                        <div class="col-md-6">
                            <a href="veiw/event-viewer.php?id=' . $row['id'] . '" class="text-decoration-none card-link" style="color: black;">
                                <div class="card mb-3 shadow-sm h-wrap">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2 text-center p-3">
                                                <i class="fa fa-calendar mt-2 fa-3x" style="color: #FFCC66  ;"></i>
                                        </div>
                                        <div class="col-10 position-relative">
                                            <div class="card-body">
                                                <h5 class="card-title">' . $row['event_name'] . '</h5>
                                                <p class="card-text">Event Date: ' . $row['event_date'] . '</p>
                    ...
                    echo '<hr><div class="alert alert-danger text-center shadow mt-3 w-100"> No Events available.</div>';
                }
