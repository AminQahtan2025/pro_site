...
<body>
    <div class="container">
        <!-- Banner Image -->
        <div class="banner">
            <img src="../images/banner.jpeg" alt="Scientific Articles Banner" class="img-fluid w-100 shadow-sm">
        </div>
        <div class="header logo d-flex flex-row">
            ...
            <div aria-label="breadcrumb" class="shadow header w-100">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Scientific Articles</li>
                </ol>
            </div>
        </div>
        <div class="container border">
            <h1 class="text-center m-4">Scientific Articles</h1>
            <div class="row g-3">
                <?php
                ...
                $sql = "SELECT * FROM s_articles LIMIT $offset, $articlesPerPage";
                $result = $conn->query($sql);
                // Fetch articles
                $sql = "SELECT * FROM s_articles";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '
                        <div class="col-md-6">
                            <a href="veiw/S_article-viewer.php?id=' . $row['id'] . '" class="text-decoration-none card-link" style="color: black;">
...
<footer class="footer shadow mt-3 w-100">
    <div class="container">
        ...
        <div class="text-center">
            <p class="mb-0 small">&copy; 2024 <a href="../index.html"
