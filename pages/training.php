...
<body>
    <div class="container">
        ...
        <div class="container border">
            <h1 class="text-center m-4">Training programs</h1>
            <div class="row g-3">
                <?php
                ...
                $totalArticlesQuery = "SELECT COUNT(*) AS total FROM training_programs";
                $totalArticlesResult = $conn->query($totalArticlesQuery);
                $totalArticles = $totalArticlesResult->fetch_assoc()['total'];

                // Fetch articles for the current page
                $sql = "SELECT * FROM training_programs LIMIT $offset, $articlesPerPage";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '
                        <div class="col-md-6">
                            <a href="veiw/training-viewer.php?id=' . $row['id'] . '" class="text-decoration-none card-link" style="color: black;">
                                <div class="card mb-3 shadow-sm h-wrap">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2 text-center p-3">
                                            <i class="fa fa-graduation-cap fa-4x" style="color: #008080;"></i>
                                        </div>
                                        <div class="col-10 position-relative">
                                            <div class="card-body">
                                                <h5 class="card-title">' . $row['program_name'] . '</h5>
