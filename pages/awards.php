...
<body>
    <div class="container">
        <!-- Banner Image -->
        <div class="banner">
            <img src="../images/banner.jpeg" alt="Achievements and Awards Banner" class="img-fluid w-100 shadow-sm">
        </div>
        ...
        <div class="container border">
            <h1 class="text-center m-4">Achievements and Awards</h1>
            <div class="row g-3">
                <?php
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '
                        <div class="col-md-6">
                            <a href="veiw/award-viewer.php?id=' . $row['id'] . '" class="text-decoration-none card-link" style="color: black;">
                                    ...
                                    <div class="row g-0 align-items-center">
                                        ...
                                        <div class="col-10 position-relative">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Event Date: ' . $row['date_received'] . '</p>
                                                <p class="card-text"><small class="text-body-secondary">Created_at: ' . $row['created_at'] . '</small></p>
                    ...
                    echo '<hr><div class="alert alert-danger text-center shadow mt-3 w-100"> No Achievements and Awards available.</div>';
                }
