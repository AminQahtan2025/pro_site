...
<body>
    <div class="container">
        <!-- Banner Image -->
        <div class="banner">
            <img src="../images/banner.jpeg" alt="Consultancy Services Banner" class="img-fluid w-100 shadow-sm">
        </div>
        <div class="header logo d-flex flex-row">
            ...
            <div aria-label="breadcrumb" class="shadow header w-100">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Consultancy Services</li>
                </ol>
            </div>
        </div>
        <div class="container border">
            <h1 class="text-center m-4">Consultancy Services</h1>
            <div class="row g-3">
                <?php
                ...
                $totalArticlesQuery = "SELECT COUNT(*) AS total FROM consultancy";
                $totalArticlesResult = $conn->query($totalArticlesQuery);
                $totalArticles = $totalArticlesResult->fetch_assoc()['total'];

                // Fetch articles for the current page
                $sql = "SELECT * FROM consultancy LIMIT $offset, $articlesPerPage";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '
                        <div class="col-md-6">
                            <a href="veiw/consultancy-viewer.php?id=' . $row['id'] . '" class="text-decoration-none card-link" style="color: black;">
                                <div class="card mb-3 shadow-sm h-wrap">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2 text-center p-3">
                                                <i class="fa fa-briefcase mt-2 fa-3x" style="color: #008080;"></i>
                                        </div>
                                        <div class="col-10 position-relative">
                                            <div class="card-body">
                                                <h5 class="card-title">' . $row['service_name'] . '</h5>
                                                <p class="card-text"><small class="text-body-secondary">Published: ' . $row['created_at'] . '</small></p>
                    ...
                    echo '<hr><div class="alert alert-danger text-center shadow mt-3 w-100"> No Consultancy Services available.</div>';
                }
