...
// Pagination settings
$consultanciesPerPage = 5; // Number of consultations per page
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1; // Current page number
$offset = ($page - 1) * $consultanciesPerPage; // Offset for SQL query

// Fetch total number of consultations
$totalConsultanciesQuery = "SELECT COUNT(*) AS total FROM consultancy";
$totalConsultanciesResult = $conn->query($totalConsultanciesQuery);
$totalConsultancies = $totalConsultanciesResult->fetch_assoc()['total'];

// Fetch consultations for the current page
$query = "SELECT * FROM consultancy LIMIT $offset, $consultanciesPerPage";
$result = $conn->query($query);

// Calculate total pages
$totalPages = ceil($totalConsultancies / $consultanciesPerPage);
?>
...
<head>
    ...
    <title>Manage Consultancy</title>
...
<body>
    ...
    <div class="content" id="content">
        <h1 class="text-center">Manage Consultancy</h1>
        <div class="d-flex justify-content-start mb-3">
            <a href="../add/add_consultancy.php" class="btn btn-success"><i class="fa fa-plus me-2"></i>Add New Consultancy</a>
        </div>
        <table class="table table-striped table-bordered table-hover w-100">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='../../pages/veiw/consultancy-viewer.php?id={$row['id']}' class='text-primary'>Read More</a>
                            </td>                            
                            <td>
                            ...
                            <td>
                                <a href='../edit/edit_consultancy.php?id={$row['id']}' class='btn btn-primary btn-sm'>
                                    <i class='fa fa-edit'></i> Edit
                                </a>
                                <a href='../delete/delete_consultancy.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this consultancy?\")'>
                    ...
                    echo "<tr><td colspan='6' class='text-center text-danger'>No consultancy services found.</td></tr>";
                }
                ?>
            </tbody>
        </table>
