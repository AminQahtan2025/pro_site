...
$offset = ($page - 1) * $eventsPerPage; // Offset for SQL query
...
$query = "SELECT * FROM events LIMIT $offset, $eventsPerPage";
...
<body>
    ...
    <div class="content" id="content">
        ...
        <div class="d-flex justify-content-start mb-3">
            <a href="../add/add_event.php" class="btn btn-success"><i class="fa fa-plus me-2"></i>Add New Event</a>
        </div>
        <table class="table table-striped table-bordered table-hover w-100">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='../../pages/veiw/event-viewer.php?id={$row['id']}' class='text-primary'>Read More</a>
                            </td>
                            ...
                            <td>
                                <a href='../edit/edit_event.php?id={$row['id']}' class='btn btn-primary btn-sm'>
                                    <i class='fa fa-edit'></i> Edit
                                </a>
                                <a href='../delete/delete_event.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this event?\")'>
                    ...
                    echo "<tr><td colspan='8' class='text-center text-danger'>No events found.</td></tr>";
                }
                ?>
            </tbody>
        </table>
