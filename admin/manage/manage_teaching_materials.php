...
// Pagination settings
$materialsPerPage = 5; // Number of teaching materials per page
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1; // Current page number
$offset = ($page - 1) * $materialsPerPage; // Offset for SQL query

// Fetch total number of teaching materials
$totalMaterialsQuery = "SELECT COUNT(*) AS total FROM teaching_materials";
$totalMaterialsResult = $conn->query($totalMaterialsQuery);
$totalMaterials = $totalMaterialsResult->fetch_assoc()['total'];

// Fetch teaching materials for the current page
$query = "SELECT * FROM teaching_materials LIMIT $offset, $materialsPerPage";
$result = $conn->query($query);

// Calculate total pages
$totalPages = ceil($totalMaterials / $materialsPerPage);
?>
...
<body>
    ...
    <div class="content" id="content">
        <h1 class="text-center">Manage Teaching Materials</h1>
        <div class="d-flex justify-content-start mb-3">
            <a href="../add/add_teaching_material.php" class="btn btn-success"><i class="fa fa-plus me-2"></i>Add New Teaching Material</a>
        </div>
        <table class="table table-striped table-bordered table-hover w-100">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='../../pages/view/teaching-material-viewer.php?id={$row['id']}' class='text-primary'>Read More</a>
                            </td>
                            <td>{$row['category']}</td>
                            <td>
                            ...
                            <td>
                                <a href='../edit/edit_teaching_material.php?id={$row['id']}' class='btn btn-primary btn-sm'>
                                    <i class='fa fa-edit'></i> Edit
                                </a>
                                <a href='../delete/delete_teaching_material.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this teaching material?\")'>
                    ...
                    echo "<tr><td colspan='6' class='text-center text-danger'>No teaching materials found.</td></tr>";
                }
                ?>
            </tbody>
        </table>
